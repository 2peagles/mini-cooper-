 ...
 <Container>
    ...
    <div className='featured-content'>
      <img src={ featuredphone }alt='Mini App for androids and ios' className='featured-img'/>
            ...
            <button className='btn btn-black'><a href='/'>download ios</a></button>
              <button className='btn btn-red'><a href='/'>download android</a></button>
            </div>
      </div>
      </Col>
        <Col sm>
          <div className='featured-content'>
            ...
            <div className='btngroup'>
              <button className=' btn btn-black'><a href='/'>learn more</a></button>
            </div>
          </div>
        </Col>
        <Col sm>
